                   ...
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=responses" class="nav-link nav-responses">
                        <i class="nav-icon fas fa-comment-dots" style="color:black;"></i>
                        <p style="color: black;">
                          Responses
                        </p>
                      </a>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=reports" class="nav-link nav-reports">
                        <i class="nav-icon far fa-circle" style="color:black;"></i>
                        <p style="color: black;">
                          Report
                        </p>
                      </a>
                    ...
                    <li class="nav-header" style="color: black;">Maintenance</li>
                    <li class="nav-item dropdown">
