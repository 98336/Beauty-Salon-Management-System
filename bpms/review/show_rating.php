...
<h1>Rating and Reviews</h1>
	...
	<div class="row">
		<div class="col-sm-2" style="width:150px">
			<img class="product_image" src="image/<?php echo $item["image"]; ?>" style="width:300px;height:300px;">
		</div>
	...
	<div id="ratingDetails"> 		
		<div class="row">			
			...
			<div class="col-sm-3">
				<button type="button" id="rateProduct" class="btn btn-info <?php if(!empty($_SESSION['userid']) && $_SESSION['userid']){ echo 'login';} ?>">Rate Our Services & Products</button>
			</div>		
		</div>
		<div class="row">
			<div class="col-sm-7">
			...
			<div class="col-sm-12">
				<form id="ratingForm" method="POST">					
					<div class="form-group">
						<h4>Rate Our Services and Products</h4>
	...
	<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="loginmodal-container">
				<h1>Login to rate our services and products</h1><br>
